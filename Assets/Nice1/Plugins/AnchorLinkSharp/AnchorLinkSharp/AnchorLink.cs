...
namespace AnchorLinkSharp
{
    ...
    public class AnchorLink : AbiSerializationProvider
    {
        ...
        public AnchorLink(ILinkOptions options)
        {
            ...
            UnityEngine.Debug.Log(" Anchor Link =" + options.ToString() + " / " + ChainId);
        }
         ...
         * @internal
         */
        public async Task<TransactResult> SendRequest(SigningRequest request, ILinkTransport transport,bool broadcast = false)
        {
            var t = transport ?? Transport;
            try
            {
        ...
        public async Task<IdentifyResult> Identify(PermissionLevel requestPermission, object info)
        {
            ...
            UnityEngine.Debug.Log(signer.actor);
            UnityEngine.Debug.Log(signer.permission);
        ...
        public async Task<CallbackPayload> WaitForCallback(string url)
        {
            ...
            UnityEngine.Debug.Log(rp.Rejected);
            if (!string.IsNullOrEmpty(rp.Rejected))
                new CancelException(rp.Rejected);
